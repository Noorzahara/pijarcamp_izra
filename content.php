...
//---------------------------- USER ---------------------------
elseif ($page == "produk") include("page/produk.php");
elseif ($page == "keranjang") include("page/user/keranjang.php");
...
elseif ($page == "keranjang_ubah") include("page/user/keranjang_ubah.php");
...
elseif ($page == "laporan") include("dashboard.php");
elseif ($page == "laporanprofit") include("profit.php");
elseif ($page == "laporanproduct") include("product.php");
elseif ($page == "laporansales") include("sales.php");
