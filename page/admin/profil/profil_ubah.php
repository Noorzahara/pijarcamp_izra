<link rel="stylesheet" href="css/profil_admin_edit.css">
    ...
    <form name="ubah" action="?page=profilad_ubahpro" method="post" enctype="multipart/form-data">
        ...
        <table class="article">
            ...
            <tr>
                <td></td>
                <td>
                    <input class="tombol-biru" type="button"
                           value="Jika melakukan perubahan data, maka akun akan otomatis KELUAR. Setelah itu MASUK lagi seperti biasa">
                </td>
            </tr>
            <tr>
                <td></td>
