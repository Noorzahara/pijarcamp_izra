...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900">Profit</h1>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $amount = "SELECT SUM((tp.qty * (tb.harga - tb.hargabeli))) AS amount FROM tbl_pesanan tp JOIN tbl_barang tb ON tp.id_barang = tb.id_barang GROUP BY tp.date_in;";
        $i = 1;
